...
labels = ['活期存款', '三个月', '半年', '一年', '二年', '三年', '五年']
...
plt.tight_layout()
plt.savefig('chinese_annual_averages.png', dpi=300, bbox_inches='tight')
plt.close()
print("✅ 年度均值图已生成")
...
plt.tight_layout()
plt.savefig('chinese_distribution_boxplot.png', dpi=300, bbox_inches='tight')
plt.close()
print("✅ 分布箱线图已生成")
...
plt.tight_layout()
plt.savefig('chinese_correlation_heatmap.png', dpi=300, bbox_inches='tight')
plt.close()
print("✅ 相关性热力图已生成")
...
plt.tight_layout()
plt.savefig('chinese_term_structure_evolution.png', dpi=300, bbox_inches='tight')
plt.close()
print("✅ 期限结构演化图已生成")
...
plt.tight_layout()
plt.savefig('chinese_data_quality.png', dpi=300, bbox_inches='tight')
plt.close()
print("✅ 数据质量可视化图已生成")
